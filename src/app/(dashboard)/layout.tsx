      ...
      <div className="flex items-center gap-3">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="h-8 gap-2 px-2 hover:bg-slate-100 text-slate-700 font-bold uppercase text-[9px] tracking-tight transition-all rounded-md border border-slate-200">
          ...
          <DropdownMenuContent align="start" className="w-56 rounded-lg shadow-xl border-slate-200 p-1">
            <DropdownMenuLabel className="text-[8px] font-black uppercase text-slate-400 px-2 py-1.5 tracking-widest">Organisation</DropdownMenuLabel>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                ...
                <span className="text-[9px] font-black uppercase tracking-wider">Suche</span>
                <kbd className="h-4 px-1 bg-slate-50 rounded flex items-center justify-center font-mono text-[8px] border border-slate-200">⌘K</kbd>
              </Button>
            </TooltipTrigger>
            <TooltipContent className="text-[9px] font-bold uppercase">Suche</TooltipContent>
          </Tooltip>
        </TooltipProvider>
