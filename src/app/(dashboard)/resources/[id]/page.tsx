              ...
              <div className="space-y-6 pt-4 border-t">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={req.label} className="flex items-center justify-between p-3 bg-white dark:bg-slate-950 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm">
                  ...
                  <Table>
                    <TableHeader className="bg-slate-50/30">
                      <TableRow>
                        ...
                        <TableHead className="text-right px-8 font-black text-[10px] uppercase text-slate-400">Details</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
